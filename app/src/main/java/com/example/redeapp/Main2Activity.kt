...
import com.example.redeapp.databinding.ActivityMain2Binding
...
class Main2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(mBinding.appBarMain2.toolbar)

        mBinding.appBarMain2.fab.setOnClickListener { view ->
